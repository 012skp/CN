...
set nf [open out_vegas.nam w]
set trace_file [open vegas.tr w]
$ns namtrace-all $nf
...
set outfile [open  "congestion_vegas.xg"  w]
...
proc finish {} {
 exec xgraph congestion_vegas.xg -geometry 300x300 &
 global ns nf
 $ns flush-trace
 #Close the NAM trace file
 close $nf
 #Execute NAM on the trace file
 exec nam out_vegas.nam &
 exit 0
}
